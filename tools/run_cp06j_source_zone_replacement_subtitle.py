...
def main() -> None:
    ...
    evidence_dir = settings.root / "evidence" / "CP06J"
    ...
    after_contact = evidence_dir / "after_cp06j_same_timestamps.jpg"
    ...
    ass_path = project_dir / "subtitles" / "cp06j_source_zone_replacement_english.ass"
    subtitle_layout = write_source_zone_replacement_ass(timeline, intervals, ass_path)
    output_path = project_dir / "renders" / "cp06j_source_zone_replacement_subtitle_720p.mp4"
    ...
    summary = {
        ...
        "contact_sheets": {
            ...
            "after_cp06j_same_timestamps": str(after_contact),
